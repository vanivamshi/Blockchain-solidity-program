...
while(True):
    ...
    ### send 7 - B to C
    cipher_text7 = cipher_b.encrypt((message2+UID+SEC+tb+nb)[0:32])
    decrypt_msg7 = decrypt_b.decrypt(cipher_text7)

    bytesToSend7 = decrypt_msg7
    UDPServerSocket.sendto(bytesToSend7, address)
    ###

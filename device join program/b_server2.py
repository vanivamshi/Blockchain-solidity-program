...
serverAddressPort_c = ("127.0.0.3", 20001)
...
while(True):
    ...
    ### send 4 - D to C
    hash4 = str(hashlib.sha256((nd+nc).encode('utf-8')).hexdigest())
    cipher_text3 = cipher_b.encrypt((message2+D+nd+hash4)[0:32])
